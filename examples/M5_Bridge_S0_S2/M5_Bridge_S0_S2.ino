...
uint32_t rightChoices[] = { 9600, 19200, 57600, 115200 };
uint8_t nRC = 4, nLC = 4; // number of choices
uint8_t lChoice = 3, rChoice = 0;
uint32_t speed0 = 115200, speed1 = 9600;

void setupBridge() {
  m5bridge.setIOFunction(tSERIAL0, tSERIAL2);
}
...
void loopPipe0() {
  ...
  m5bridge.setSerial0Speed(speed0);
  drawCenter();
}
...
void loopPipe1() {
  ...
  speed1 = rightChoices[rChoice] * 1E6;
  m5bridge.setSerial2Speed(speed1);
  drawCenter();
}
